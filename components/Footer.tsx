...
const footerLinks = [
  { icon: Mail, text: 'email', href: 'mailto:sam@samou.co.uk' },
      ...
      <div className="mx-auto max-w-5xl px-6 py-12 sm:px-8 sm:py-14">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2 lowercase">
            ...
            <a
              href="mailto:sam@samou.co.uk"
              className="text-xs font-light text-slate-500 transition-colors hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100"
            >
              sam@samou.co.uk
            </a>
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:gap-12 lg:gap-16">
            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs font-light lowercase text-slate-500 dark:text-slate-400">
